...
[CustomEditor(typeof(BaseAudioKeeper))]
public class BaseAudioKeeperEditor : Editor {
	...
	void OnEnable()
	{
		...
		if(elementVisibility==null || elementVisibility.Count<1)
		{
			...
			for(int i=0;i<s_Object.FindProperty("allAudioClips").arraySize;i++)
	...
	public override void OnInspectorGUI ()
	{
		...
		ListIterator("allAudioClips",ref listVisibility);
