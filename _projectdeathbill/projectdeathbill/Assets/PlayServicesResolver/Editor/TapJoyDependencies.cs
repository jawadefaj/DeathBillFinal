...
/// </summary>
[InitializeOnLoad]
public static class TapJoyDependencies
{
    /// <summary>
    ...
    private static readonly string PluginName = "TapJoy";

    /// <summary>
    /// Initializes static members of the <see cref="SampleDependencies"/> class.
    /// </summary>
    static TapJoyDependencies()
    {
        ...
        // add your dependencies here
         ...
         svcSupport.DependOn("com.google.android.gms", "play-services-analytics", "8.4");
    }
