...
/// </summary>
[InitializeOnLoad]
public static class IronSourceDependencies
{
    /// <summary>
    ...
    private static readonly string PluginName = "IronSource";

    /// <summary>
    /// Initializes static members of the <see cref="SampleDependencies"/> class.
    /// </summary>
    static IronSourceDependencies()
    {
        ...
        svcSupport.DependOn("com.google.android.gms", "play-services-ads", "8.4");
    }
